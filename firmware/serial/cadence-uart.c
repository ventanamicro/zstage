...
#include <zstage/riscv_io.h>
#include <zstage/console.h>
#include <zstage/serial/cadence-uart.h>
...
static struct zstage_console_device cadence_console = {
	.name = "cadence_uart",
...
int cadence_uart_init(unsigned long base, u32 in_freq, u32 baudrate)
{
	...
	zstage_console_set_device(&cadence_console);
